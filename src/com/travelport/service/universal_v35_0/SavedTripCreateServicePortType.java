 ...
 * 2016-05-08T13:24:25.608-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v35_0", name = "SavedTripCreateServicePortType")
...
public interface SavedTripCreateServicePortType {
    ...
    @WebResult(name = "SavedTripCreateRsp", targetNamespace = "http://www.travelport.com/schema/universal_v35_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripCreateService")
    public com.travelport.schema.universal_v35_0.SavedTripCreateRsp service(
        @WebParam(partName = "parameters", name = "SavedTripCreateReq", targetNamespace = "http://www.travelport.com/schema/universal_v35_0")
        com.travelport.schema.universal_v35_0.SavedTripCreateReq parameters,
