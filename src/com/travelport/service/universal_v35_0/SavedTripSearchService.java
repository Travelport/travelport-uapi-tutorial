...
public class SavedTripSearchService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.travelport.com/service/universal_v35_0", "SavedTripSearchService");
    public final static QName SavedTripSearchServicePort = new QName("http://www.travelport.com/service/universal_v35_0", "SavedTripSearchServicePort");
    static {
        URL url = null;
        try {
