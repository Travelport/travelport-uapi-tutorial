 ...
 * 2016-05-08T13:24:25.749-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v35_0", name = "UniversalRecordSearchServicePortType")
...
public interface UniversalRecordSearchServicePortType {
    ...
    @WebResult(name = "UniversalRecordSearchRsp", targetNamespace = "http://www.travelport.com/schema/universal_v35_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordService")
    public com.travelport.schema.universal_v35_0.UniversalRecordSearchRsp service(
        @WebParam(partName = "parameters", name = "UniversalRecordSearchReq", targetNamespace = "http://www.travelport.com/schema/universal_v35_0")
        com.travelport.schema.universal_v35_0.UniversalRecordSearchReq parameters
