 ...
 * 2016-05-15T12:42:01.492-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v35_0", name = "HotelCancelServicePortType")
...
public interface HotelCancelServicePortType {
    ...
    @WebResult(name = "HotelCancelRsp", targetNamespace = "http://www.travelport.com/schema/universal_v35_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/HotelService")
    public com.travelport.schema.universal_v35_0.HotelCancelRsp service(
        @WebParam(partName = "parameters", name = "HotelCancelReq", targetNamespace = "http://www.travelport.com/schema/universal_v35_0")
        com.travelport.schema.universal_v35_0.HotelCancelReq parameters,
