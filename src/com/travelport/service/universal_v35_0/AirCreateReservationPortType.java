 ...
 * 2016-05-08T13:24:25.317-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v35_0", name = "AirCreateReservationPortType")
...
public interface AirCreateReservationPortType {
    ...
    @WebResult(name = "AirCreateReservationRsp", targetNamespace = "http://www.travelport.com/schema/universal_v35_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.universal_v35_0.AirCreateReservationRsp service(
        @WebParam(partName = "parameters", name = "AirCreateReservationReq", targetNamespace = "http://www.travelport.com/schema/universal_v35_0")
        com.travelport.schema.universal_v35_0.AirCreateReservationReq parameters,
