 ...
 * 2016-05-08T13:24:25.499-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v35_0", name = "RailCreateReservationPortType")
...
public interface RailCreateReservationPortType {
    ...
    @WebResult(name = "RailCreateReservationRsp", targetNamespace = "http://www.travelport.com/schema/universal_v35_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/RailService")
    public com.travelport.schema.universal_v35_0.RailCreateReservationRsp service(
        @WebParam(partName = "parameters", name = "RailCreateReservationReq", targetNamespace = "http://www.travelport.com/schema/universal_v35_0")
        com.travelport.schema.universal_v35_0.RailCreateReservationReq parameters
