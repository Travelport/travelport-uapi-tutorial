 ...
 * 2016-05-15T12:42:01.348-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v35_0", name = "SavedTripDeleteServicePortType")
...
public interface SavedTripDeleteServicePortType {
    ...
    @WebResult(name = "SavedTripDeleteRsp", targetNamespace = "http://www.travelport.com/schema/universal_v35_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripDeleteService")
    public com.travelport.schema.universal_v35_0.SavedTripDeleteRsp service(
        @WebParam(partName = "parameters", name = "SavedTripDeleteReq", targetNamespace = "http://www.travelport.com/schema/universal_v35_0")
        com.travelport.schema.universal_v35_0.SavedTripDeleteReq parameters,
