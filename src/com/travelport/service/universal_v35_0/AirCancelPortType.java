 ...
 * 2016-05-15T12:42:01.329-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v35_0", name = "AirCancelPortType")
...
public interface AirCancelPortType {
    ...
    @WebResult(name = "AirCancelRsp", targetNamespace = "http://www.travelport.com/schema/universal_v35_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.universal_v35_0.AirCancelRsp service(
        @WebParam(partName = "parameters", name = "AirCancelReq", targetNamespace = "http://www.travelport.com/schema/universal_v35_0")
        com.travelport.schema.universal_v35_0.AirCancelReq parameters,
