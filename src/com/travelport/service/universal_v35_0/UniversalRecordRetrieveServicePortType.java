 ...
 * 2016-05-15T12:42:01.564-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v35_0", name = "UniversalRecordRetrieveServicePortType")
...
public interface UniversalRecordRetrieveServicePortType {
    ...
    @WebResult(name = "UniversalRecordRetrieveRsp", targetNamespace = "http://www.travelport.com/schema/universal_v35_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordService")
    public com.travelport.schema.universal_v35_0.UniversalRecordRetrieveRsp service(
        @WebParam(partName = "parameters", name = "UniversalRecordRetrieveReq", targetNamespace = "http://www.travelport.com/schema/universal_v35_0")
        com.travelport.schema.universal_v35_0.UniversalRecordRetrieveReq parameters,
