 ...
 * 2016-05-08T13:24:25.551-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v35_0", name = "SavedTripSearchServicePortType")
...
public interface SavedTripSearchServicePortType {
    ...
    @WebResult(name = "SavedTripSearchRsp", targetNamespace = "http://www.travelport.com/schema/universal_v35_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripSearchService")
    public com.travelport.schema.universal_v35_0.SavedTripSearchRsp service(
        @WebParam(partName = "parameters", name = "SavedTripSearchReq", targetNamespace = "http://www.travelport.com/schema/universal_v35_0")
        com.travelport.schema.universal_v35_0.SavedTripSearchReq parameters,
