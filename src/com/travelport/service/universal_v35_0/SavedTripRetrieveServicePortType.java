 ...
 * 2016-05-15T12:42:01.519-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v35_0", name = "SavedTripRetrieveServicePortType")
...
public interface SavedTripRetrieveServicePortType {
    ...
    @WebResult(name = "SavedTripRetrieveRsp", targetNamespace = "http://www.travelport.com/schema/universal_v35_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripRetrieveService")
    public com.travelport.schema.universal_v35_0.SavedTripRetrieveRsp service(
        @WebParam(partName = "parameters", name = "SavedTripRetrieveReq", targetNamespace = "http://www.travelport.com/schema/universal_v35_0")
        com.travelport.schema.universal_v35_0.SavedTripRetrieveReq parameters,
