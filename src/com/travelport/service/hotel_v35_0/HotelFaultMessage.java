...
public class HotelFaultMessage extends Exception {
    ...
    public HotelFaultMessage(String message, com.travelport.schema.common_v35_0.ErrorInfo errorInfo) {
        super(message);
        this.errorInfo = errorInfo;
    }

    public HotelFaultMessage(String message, com.travelport.schema.common_v35_0.ErrorInfo errorInfo, Throwable cause) {
        super(message, cause);
        this.errorInfo = errorInfo;
    }
