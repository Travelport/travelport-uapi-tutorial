 ...
 * 2016-09-13T11:29:56.931-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/air_v38_0", name = "AirPricePortType")
...
public interface AirPricePortType {
    ...
    @WebResult(name = "AirPriceRsp", targetNamespace = "http://www.travelport.com/schema/air_v38_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.air_v38_0.AirPriceRsp service(
        @WebParam(partName = "parameters", name = "AirPriceReq", targetNamespace = "http://www.travelport.com/schema/air_v38_0")
        com.travelport.schema.air_v38_0.AirPriceReq parameters,
