 ...
 * 2016-09-13T11:29:56.829-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/air_v38_0", name = "AirFareDisplayPortType")
...
public interface AirFareDisplayPortType {
    ...
    @WebResult(name = "AirFareDisplayRsp", targetNamespace = "http://www.travelport.com/schema/air_v38_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.air_v38_0.AirFareDisplayRsp service(
        @WebParam(partName = "parameters", name = "AirFareDisplayReq", targetNamespace = "http://www.travelport.com/schema/air_v38_0")
        com.travelport.schema.air_v38_0.AirFareDisplayReq parameters,
