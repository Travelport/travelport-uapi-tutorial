...
public class UniversalRecordFaultMessage extends Exception {
    ...
    public UniversalRecordFaultMessage(String message, com.travelport.schema.common_v42_0.ErrorInfo errorInfo) {
        super(message);
        this.errorInfo = errorInfo;
    }

    public UniversalRecordFaultMessage(String message, com.travelport.schema.common_v42_0.ErrorInfo errorInfo, Throwable cause) {
        super(message, cause);
        this.errorInfo = errorInfo;
    }
