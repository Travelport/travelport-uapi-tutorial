 ...
 * 2017-07-31T15:56:05.152-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v42_0", name = "SavedTripModifyServicePortType")
...
public interface SavedTripModifyServicePortType {
    ...
    @WebResult(name = "SavedTripModifyRsp", targetNamespace = "http://www.travelport.com/schema/universal_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripModifyService")
    public com.travelport.schema.universal_v42_0.SavedTripModifyRsp service(
        @WebParam(partName = "parameters", name = "SavedTripModifyReq", targetNamespace = "http://www.travelport.com/schema/universal_v42_0")
        com.travelport.schema.universal_v42_0.SavedTripModifyReq parameters,
