 ...
 * 2017-07-31T15:56:05.113-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v42_0", name = "UniversalRecordRetrieveServicePortType")
...
public interface UniversalRecordRetrieveServicePortType {
    ...
    @WebResult(name = "UniversalRecordRetrieveRsp", targetNamespace = "http://www.travelport.com/schema/universal_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordService")
    public com.travelport.schema.universal_v42_0.UniversalRecordRetrieveRsp service(
        @WebParam(partName = "parameters", name = "UniversalRecordRetrieveReq", targetNamespace = "http://www.travelport.com/schema/universal_v42_0")
        com.travelport.schema.universal_v42_0.UniversalRecordRetrieveReq parameters,
