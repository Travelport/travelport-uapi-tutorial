 ...
 * 2017-07-31T15:56:04.994-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v42_0", name = "VehicleReservationServicePortType")
...
public interface VehicleReservationServicePortType {
    ...
    @WebResult(name = "VehicleCreateReservationRsp", targetNamespace = "http://www.travelport.com/schema/universal_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/VehicleService")
    public com.travelport.schema.universal_v42_0.VehicleCreateReservationRsp service(
        @WebParam(partName = "parameters", name = "VehicleCreateReservationReq", targetNamespace = "http://www.travelport.com/schema/universal_v42_0")
        com.travelport.schema.universal_v42_0.VehicleCreateReservationReq parameters,
    ...
    ) throws PriceFaultMessage, VehicleFaultMessage;
}
