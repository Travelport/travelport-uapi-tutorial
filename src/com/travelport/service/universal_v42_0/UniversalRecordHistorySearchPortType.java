 ...
 * 2017-07-31T15:56:05.011-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v42_0", name = "UniversalRecordHistorySearchPortType")
...
public interface UniversalRecordHistorySearchPortType {
    ...
    @WebResult(name = "UniversalRecordHistorySearchRsp", targetNamespace = "http://www.travelport.com/schema/universal_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordHistorySearchService")
    public com.travelport.schema.universal_v42_0.UniversalRecordHistorySearchRsp service(
        @WebParam(partName = "parameters", name = "UniversalRecordHistorySearchReq", targetNamespace = "http://www.travelport.com/schema/universal_v42_0")
        com.travelport.schema.universal_v42_0.UniversalRecordHistorySearchReq parameters,
