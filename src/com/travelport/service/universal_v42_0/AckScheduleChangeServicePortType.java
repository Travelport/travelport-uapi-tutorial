 ...
 * 2017-07-31T15:56:05.136-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v42_0", name = "AckScheduleChangeServicePortType")
...
public interface AckScheduleChangeServicePortType {
    ...
    @WebResult(name = "AckScheduleChangeRsp", targetNamespace = "http://www.travelport.com/schema/universal_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/ScheduleChangeService")
    public com.travelport.schema.universal_v42_0.AckScheduleChangeRsp service(
        @WebParam(partName = "parameters", name = "AckScheduleChangeReq", targetNamespace = "http://www.travelport.com/schema/universal_v42_0")
        com.travelport.schema.universal_v42_0.AckScheduleChangeReq parameters,
