 ...
 * 2017-07-31T15:56:05.056-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v42_0", name = "AirCancelPortType")
...
public interface AirCancelPortType {
    ...
    @WebResult(name = "AirCancelRsp", targetNamespace = "http://www.travelport.com/schema/universal_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.universal_v42_0.AirCancelRsp service(
        @WebParam(partName = "parameters", name = "AirCancelReq", targetNamespace = "http://www.travelport.com/schema/universal_v42_0")
        com.travelport.schema.universal_v42_0.AirCancelReq parameters,
