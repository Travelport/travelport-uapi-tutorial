 ...
 * 2017-07-31T15:56:05.089-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v42_0", name = "PassiveReservationServicePortType")
...
public interface PassiveReservationServicePortType {
    ...
    @WebResult(name = "PassiveCreateReservationRsp", targetNamespace = "http://www.travelport.com/schema/universal_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/PassiveService")
    public com.travelport.schema.universal_v42_0.PassiveCreateReservationRsp service(
        @WebParam(partName = "parameters", name = "PassiveCreateReservationReq", targetNamespace = "http://www.travelport.com/schema/universal_v42_0")
        com.travelport.schema.universal_v42_0.PassiveCreateReservationReq parameters,
