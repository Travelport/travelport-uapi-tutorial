 ...
 * 2017-07-31T15:56:05.107-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v42_0", name = "ProviderReservationDivideServicePortType")
...
public interface ProviderReservationDivideServicePortType {
    ...
    @WebResult(name = "ProviderReservationDivideRsp", targetNamespace = "http://www.travelport.com/schema/universal_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordService")
    public com.travelport.schema.universal_v42_0.ProviderReservationDivideRsp service(
        @WebParam(partName = "parameters", name = "ProviderReservationDivideReq", targetNamespace = "http://www.travelport.com/schema/universal_v42_0")
        com.travelport.schema.universal_v42_0.ProviderReservationDivideReq parameters
