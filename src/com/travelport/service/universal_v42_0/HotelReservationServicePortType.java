 ...
 * 2017-07-31T15:56:05.078-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v42_0", name = "HotelReservationServicePortType")
...
public interface HotelReservationServicePortType {
    ...
    @WebResult(name = "HotelCreateReservationRsp", targetNamespace = "http://www.travelport.com/schema/universal_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/HotelService")
    public com.travelport.schema.universal_v42_0.HotelCreateReservationRsp service(
        @WebParam(partName = "parameters", name = "HotelCreateReservationReq", targetNamespace = "http://www.travelport.com/schema/universal_v42_0")
        com.travelport.schema.universal_v42_0.HotelCreateReservationReq parameters,
    ...
    ) throws PriceFaultMessage, HotelFaultMessage;
}
