 ...
 * 2017-07-31T15:56:05.062-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v42_0", name = "SavedTripDeleteServicePortType")
...
public interface SavedTripDeleteServicePortType {
    ...
    @WebResult(name = "SavedTripDeleteRsp", targetNamespace = "http://www.travelport.com/schema/universal_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripDeleteService")
    public com.travelport.schema.universal_v42_0.SavedTripDeleteRsp service(
        @WebParam(partName = "parameters", name = "SavedTripDeleteReq", targetNamespace = "http://www.travelport.com/schema/universal_v42_0")
        com.travelport.schema.universal_v42_0.SavedTripDeleteReq parameters,
