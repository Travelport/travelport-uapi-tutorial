 ...
 * 2017-07-31T15:56:04.988-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v42_0", name = "VehicleCancelServicePortType")
...
public interface VehicleCancelServicePortType {
    ...
    @WebResult(name = "VehicleCancelRsp", targetNamespace = "http://www.travelport.com/schema/universal_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/VehicleService")
    public com.travelport.schema.universal_v42_0.VehicleCancelRsp service(
        @WebParam(partName = "parameters", name = "VehicleCancelReq", targetNamespace = "http://www.travelport.com/schema/universal_v42_0")
        com.travelport.schema.universal_v42_0.VehicleCancelReq parameters,
