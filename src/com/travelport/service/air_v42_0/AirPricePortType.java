 ...
 * 2017-07-31T15:51:36.469-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/air_v42_0", name = "AirPricePortType")
...
public interface AirPricePortType {
    ...
    @WebResult(name = "AirPriceRsp", targetNamespace = "http://www.travelport.com/schema/air_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.air_v42_0.AirPriceRsp service(
        @WebParam(partName = "parameters", name = "AirPriceReq", targetNamespace = "http://www.travelport.com/schema/air_v42_0")
        com.travelport.schema.air_v42_0.AirPriceReq parameters,
