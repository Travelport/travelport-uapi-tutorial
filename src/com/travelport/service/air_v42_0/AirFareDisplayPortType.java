 ...
 * 2017-07-31T15:51:35.918-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/air_v42_0", name = "AirFareDisplayPortType")
...
public interface AirFareDisplayPortType {
    ...
    @WebResult(name = "AirFareDisplayRsp", targetNamespace = "http://www.travelport.com/schema/air_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.air_v42_0.AirFareDisplayRsp service(
        @WebParam(partName = "parameters", name = "AirFareDisplayReq", targetNamespace = "http://www.travelport.com/schema/air_v42_0")
        com.travelport.schema.air_v42_0.AirFareDisplayReq parameters,
