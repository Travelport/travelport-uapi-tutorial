 ...
 * 2017-07-31T15:51:35.935-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/air_v42_0", name = "SeatMapPortType")
...
public interface SeatMapPortType {
    ...
    @WebResult(name = "SeatMapRsp", targetNamespace = "http://www.travelport.com/schema/air_v42_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.air_v42_0.SeatMapRsp service(
        @WebParam(partName = "parameters", name = "SeatMapReq", targetNamespace = "http://www.travelport.com/schema/air_v42_0")
        com.travelport.schema.air_v42_0.SeatMapReq parameters,
