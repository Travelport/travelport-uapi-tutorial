 ...
 * 2014-04-08T11:02:25.422-06:00
 * Generated source version: 2.7.10
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v26_0", name = "SavedTripModifyServicePortType")
...
public interface SavedTripModifyServicePortType {
    ...
    @WebResult(name = "SavedTripModifyRsp", targetNamespace = "http://www.travelport.com/schema/universal_v26_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripModifyService")
    public com.travelport.schema.universal_v26_0.SavedTripModifyRsp service(
        @WebParam(partName = "parameters", name = "SavedTripModifyReq", targetNamespace = "http://www.travelport.com/schema/universal_v26_0")
        com.travelport.schema.universal_v26_0.SavedTripModifyReq parameters,
