 ...
 * 2014-04-08T11:02:25.458-06:00
 * Generated source version: 2.7.10
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v26_0", name = "SavedTripDeleteServicePortType")
...
public interface SavedTripDeleteServicePortType {
    ...
    @WebResult(name = "SavedTripDeleteRsp", targetNamespace = "http://www.travelport.com/schema/universal_v26_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripDeleteService")
    public com.travelport.schema.universal_v26_0.SavedTripDeleteRsp service(
        @WebParam(partName = "parameters", name = "SavedTripDeleteReq", targetNamespace = "http://www.travelport.com/schema/universal_v26_0")
        com.travelport.schema.universal_v26_0.SavedTripDeleteReq parameters,
