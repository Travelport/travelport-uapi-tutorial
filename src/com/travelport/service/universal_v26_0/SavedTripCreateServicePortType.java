 ...
 * 2014-04-08T11:02:25.399-06:00
 * Generated source version: 2.7.10
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v26_0", name = "SavedTripCreateServicePortType")
...
public interface SavedTripCreateServicePortType {
    ...
    @WebResult(name = "SavedTripCreateRsp", targetNamespace = "http://www.travelport.com/schema/universal_v26_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripCreateService")
    public com.travelport.schema.universal_v26_0.SavedTripCreateRsp service(
        @WebParam(partName = "parameters", name = "SavedTripCreateReq", targetNamespace = "http://www.travelport.com/schema/universal_v26_0")
        com.travelport.schema.universal_v26_0.SavedTripCreateReq parameters,
