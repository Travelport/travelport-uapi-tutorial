 ...
 * 2014-04-08T11:02:25.413-06:00
 * Generated source version: 2.7.10
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v26_0", name = "UniversalRecordImportServicePortType")
...
public interface UniversalRecordImportServicePortType {
    ...
    @WebResult(name = "UniversalRecordImportRsp", targetNamespace = "http://www.travelport.com/schema/universal_v26_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordService")
    public com.travelport.schema.universal_v26_0.UniversalRecordImportRsp service(
        @WebParam(partName = "parameters", name = "UniversalRecordImportReq", targetNamespace = "http://www.travelport.com/schema/universal_v26_0")
        com.travelport.schema.universal_v26_0.UniversalRecordImportReq parameters,
