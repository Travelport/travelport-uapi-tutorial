 ...
 * 2014-04-08T11:02:25.453-06:00
 * Generated source version: 2.7.10
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v26_0", name = "AirCancelPortType")
...
public interface AirCancelPortType {
    ...
    @WebResult(name = "AirCancelRsp", targetNamespace = "http://www.travelport.com/schema/universal_v26_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.universal_v26_0.AirCancelRsp service(
        @WebParam(partName = "parameters", name = "AirCancelReq", targetNamespace = "http://www.travelport.com/schema/universal_v26_0")
        com.travelport.schema.universal_v26_0.AirCancelReq parameters,
