 ...
 * 2014-04-08T11:02:25.475-06:00
 * Generated source version: 2.7.10
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v26_0", name = "HotelCancelServicePortType")
...
public interface HotelCancelServicePortType {
    ...
    @WebResult(name = "HotelCancelRsp", targetNamespace = "http://www.travelport.com/schema/universal_v26_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/HotelService")
    public com.travelport.schema.universal_v26_0.HotelCancelRsp service(
        @WebParam(partName = "parameters", name = "HotelCancelReq", targetNamespace = "http://www.travelport.com/schema/universal_v26_0")
        com.travelport.schema.universal_v26_0.HotelCancelReq parameters,
