 ...
 * 2014-04-08T11:02:25.408-06:00
 * Generated source version: 2.7.10
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v26_0", name = "AckScheduleChangeServicePortType")
...
public interface AckScheduleChangeServicePortType {
    ...
    @WebResult(name = "AckScheduleChangeRsp", targetNamespace = "http://www.travelport.com/schema/universal_v26_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/ScheduleChangeService")
    public com.travelport.schema.universal_v26_0.AckScheduleChangeRsp service(
        @WebParam(partName = "parameters", name = "AckScheduleChangeReq", targetNamespace = "http://www.travelport.com/schema/universal_v26_0")
        com.travelport.schema.universal_v26_0.AckScheduleChangeReq parameters,
