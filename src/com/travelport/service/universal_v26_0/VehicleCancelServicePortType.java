 ...
 * 2014-04-08T11:02:25.426-06:00
 * Generated source version: 2.7.10
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v26_0", name = "VehicleCancelServicePortType")
...
public interface VehicleCancelServicePortType {
    ...
    @WebResult(name = "VehicleCancelRsp", targetNamespace = "http://www.travelport.com/schema/universal_v26_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/VehicleService")
    public com.travelport.schema.universal_v26_0.VehicleCancelRsp service(
        @WebParam(partName = "parameters", name = "VehicleCancelReq", targetNamespace = "http://www.travelport.com/schema/universal_v26_0")
        com.travelport.schema.universal_v26_0.VehicleCancelReq parameters,
