 ...
 * 2016-09-13T11:38:38.254-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v38_0", name = "SavedTripRetrieveServicePortType")
...
public interface SavedTripRetrieveServicePortType {
    ...
    @WebResult(name = "SavedTripRetrieveRsp", targetNamespace = "http://www.travelport.com/schema/universal_v38_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripRetrieveService")
    public com.travelport.schema.universal_v38_0.SavedTripRetrieveRsp service(
        @WebParam(partName = "parameters", name = "SavedTripRetrieveReq", targetNamespace = "http://www.travelport.com/schema/universal_v38_0")
        com.travelport.schema.universal_v38_0.SavedTripRetrieveReq parameters,
