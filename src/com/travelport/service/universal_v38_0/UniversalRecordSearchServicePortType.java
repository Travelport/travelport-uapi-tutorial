 ...
 * 2016-09-13T11:38:38.266-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v38_0", name = "UniversalRecordSearchServicePortType")
...
public interface UniversalRecordSearchServicePortType {
    ...
    @WebResult(name = "UniversalRecordSearchRsp", targetNamespace = "http://www.travelport.com/schema/universal_v38_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordService")
    public com.travelport.schema.universal_v38_0.UniversalRecordSearchRsp service(
        @WebParam(partName = "parameters", name = "UniversalRecordSearchReq", targetNamespace = "http://www.travelport.com/schema/universal_v38_0")
        com.travelport.schema.universal_v38_0.UniversalRecordSearchReq parameters
