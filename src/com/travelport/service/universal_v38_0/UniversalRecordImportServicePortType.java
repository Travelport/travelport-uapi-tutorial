 ...
 * 2016-09-13T11:38:38.250-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v38_0", name = "UniversalRecordImportServicePortType")
...
public interface UniversalRecordImportServicePortType {
    ...
    @WebResult(name = "UniversalRecordImportRsp", targetNamespace = "http://www.travelport.com/schema/universal_v38_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordService")
    public com.travelport.schema.universal_v38_0.UniversalRecordImportRsp service(
        @WebParam(partName = "parameters", name = "UniversalRecordImportReq", targetNamespace = "http://www.travelport.com/schema/universal_v38_0")
        com.travelport.schema.universal_v38_0.UniversalRecordImportReq parameters,
