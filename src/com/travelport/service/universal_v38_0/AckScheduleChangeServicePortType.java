 ...
 * 2016-09-13T11:38:38.245-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v38_0", name = "AckScheduleChangeServicePortType")
...
public interface AckScheduleChangeServicePortType {
    ...
    @WebResult(name = "AckScheduleChangeRsp", targetNamespace = "http://www.travelport.com/schema/universal_v38_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/ScheduleChangeService")
    public com.travelport.schema.universal_v38_0.AckScheduleChangeRsp service(
        @WebParam(partName = "parameters", name = "AckScheduleChangeReq", targetNamespace = "http://www.travelport.com/schema/universal_v38_0")
        com.travelport.schema.universal_v38_0.AckScheduleChangeReq parameters,
