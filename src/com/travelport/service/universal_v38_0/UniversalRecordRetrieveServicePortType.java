 ...
 * 2016-09-13T11:38:38.273-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v38_0", name = "UniversalRecordRetrieveServicePortType")
...
public interface UniversalRecordRetrieveServicePortType {
    ...
    @WebResult(name = "UniversalRecordRetrieveRsp", targetNamespace = "http://www.travelport.com/schema/universal_v38_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordService")
    public com.travelport.schema.universal_v38_0.UniversalRecordRetrieveRsp service(
        @WebParam(partName = "parameters", name = "UniversalRecordRetrieveReq", targetNamespace = "http://www.travelport.com/schema/universal_v38_0")
        com.travelport.schema.universal_v38_0.UniversalRecordRetrieveReq parameters,
