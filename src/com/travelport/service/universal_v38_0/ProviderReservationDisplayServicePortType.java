 ...
 * 2016-09-13T11:38:38.234-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v38_0", name = "ProviderReservationDisplayServicePortType")
...
public interface ProviderReservationDisplayServicePortType {
    ...
    @WebResult(name = "ProviderReservationDisplayDetailsRsp", targetNamespace = "http://www.travelport.com/schema/universal_v38_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/ProviderReservationDisplayService")
    public com.travelport.schema.universal_v38_0.ProviderReservationDisplayDetailsRsp service(
        @WebParam(partName = "parameters", name = "ProviderReservationDisplayDetailsReq", targetNamespace = "http://www.travelport.com/schema/universal_v38_0")
        com.travelport.schema.universal_v38_0.ProviderReservationDisplayDetailsReq parameters
