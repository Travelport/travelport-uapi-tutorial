 ...
 * 2016-09-13T11:38:38.326-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v38_0", name = "UniversalRecordHistorySearchPortType")
...
public interface UniversalRecordHistorySearchPortType {
    ...
    @WebResult(name = "UniversalRecordHistorySearchRsp", targetNamespace = "http://www.travelport.com/schema/universal_v38_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordHistorySearchService")
    public com.travelport.schema.universal_v38_0.UniversalRecordHistorySearchRsp service(
        @WebParam(partName = "parameters", name = "UniversalRecordHistorySearchReq", targetNamespace = "http://www.travelport.com/schema/universal_v38_0")
        com.travelport.schema.universal_v38_0.UniversalRecordHistorySearchReq parameters,
