 ...
 * 2016-09-13T11:38:38.306-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v38_0", name = "AirMerchandisingFulfillmentPortType")
...
public interface AirMerchandisingFulfillmentPortType {
    ...
    @WebResult(name = "AirMerchandisingFulfillmentRsp", targetNamespace = "http://www.travelport.com/schema/universal_v38_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.universal_v38_0.AirMerchandisingFulfillmentRsp service(
        @WebParam(partName = "parameters", name = "AirMerchandisingFulfillmentReq", targetNamespace = "http://www.travelport.com/schema/universal_v38_0")
        com.travelport.schema.universal_v38_0.AirMerchandisingFulfillmentReq parameters,
