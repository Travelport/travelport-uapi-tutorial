 ...
 * 2016-09-13T11:38:38.257-06:00
 * Generated source version: 3.1.5
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v38_0", name = "SavedTripCreateServicePortType")
...
public interface SavedTripCreateServicePortType {
    ...
    @WebResult(name = "SavedTripCreateRsp", targetNamespace = "http://www.travelport.com/schema/universal_v38_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripCreateService")
    public com.travelport.schema.universal_v38_0.SavedTripCreateRsp service(
        @WebParam(partName = "parameters", name = "SavedTripCreateReq", targetNamespace = "http://www.travelport.com/schema/universal_v38_0")
        com.travelport.schema.universal_v38_0.SavedTripCreateReq parameters,
