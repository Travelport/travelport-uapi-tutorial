...
public class VehicleService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.travelport.com/service/vehicle_v35_0", "VehicleService");
    public final static QName VehicleLocationDetailServicePort = new QName("http://www.travelport.com/service/vehicle_v35_0", "VehicleLocationDetailServicePort");
    public final static QName VehicleUpsellSearchServicePort = new QName("http://www.travelport.com/service/vehicle_v35_0", "VehicleUpsellSearchServicePort");
    public final static QName VehicleLocationServicePort = new QName("http://www.travelport.com/service/vehicle_v35_0", "VehicleLocationServicePort");
    public final static QName VehicleRetrieveServicePort = new QName("http://www.travelport.com/service/vehicle_v35_0", "VehicleRetrieveServicePort");
    public final static QName VehicleKeywordsServicePort = new QName("http://www.travelport.com/service/vehicle_v35_0", "VehicleKeywordsServicePort");
    public final static QName VehicleRulesServicePort = new QName("http://www.travelport.com/service/vehicle_v35_0", "VehicleRulesServicePort");
    public final static QName VehicleSearchServicePort = new QName("http://www.travelport.com/service/vehicle_v35_0", "VehicleSearchServicePort");
    public final static QName VehicleMediaLinksServicePort = new QName("http://www.travelport.com/service/vehicle_v35_0", "VehicleMediaLinksServicePort");
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Travelport_1/SamplesAutoMation/AutoWork/travelport-uapi-tutorial-v35/Wsdl/vehicle_v35_0/Vehicle.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(VehicleService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Travelport_1/SamplesAutoMation/AutoWork/travelport-uapi-tutorial-v35/Wsdl/vehicle_v35_0/Vehicle.wsdl");
        }
        WSDL_LOCATION = url;
    }
