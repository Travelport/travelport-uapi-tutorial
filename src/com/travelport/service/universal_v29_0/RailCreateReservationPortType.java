 ...
 * 2014-09-19T15:08:10.090-06:00
 * Generated source version: 2.7.12
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v29_0", name = "RailCreateReservationPortType")
...
public interface RailCreateReservationPortType {
    ...
    @WebResult(name = "RailCreateReservationRsp", targetNamespace = "http://www.travelport.com/schema/universal_v29_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/RailService")
    public com.travelport.schema.universal_v29_0.RailCreateReservationRsp service(
        @WebParam(partName = "parameters", name = "RailCreateReservationReq", targetNamespace = "http://www.travelport.com/schema/universal_v29_0")
        com.travelport.schema.universal_v29_0.RailCreateReservationReq parameters
