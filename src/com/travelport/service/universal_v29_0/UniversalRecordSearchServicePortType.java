 ...
 * 2014-09-19T15:08:10.042-06:00
 * Generated source version: 2.7.12
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v29_0", name = "UniversalRecordSearchServicePortType")
...
public interface UniversalRecordSearchServicePortType {
    ...
    @WebResult(name = "UniversalRecordSearchRsp", targetNamespace = "http://www.travelport.com/schema/universal_v29_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordService")
    public com.travelport.schema.universal_v29_0.UniversalRecordSearchRsp service(
        @WebParam(partName = "parameters", name = "UniversalRecordSearchReq", targetNamespace = "http://www.travelport.com/schema/universal_v29_0")
        com.travelport.schema.universal_v29_0.UniversalRecordSearchReq parameters
