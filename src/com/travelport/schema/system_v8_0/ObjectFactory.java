 ...
 * generated in the com.travelport.schema.system_v8_0 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Password_QNAME = new QName("http://www.travelport.com/schema/system_v8_0", "Password");
    private final static QName _Payload_QNAME = new QName("http://www.travelport.com/schema/system_v8_0", "Payload");
    private final static QName _SystemTime_QNAME = new QName("http://www.travelport.com/schema/system_v8_0", "SystemTime");
    private final static QName _UserId_QNAME = new QName("http://www.travelport.com/schema/system_v8_0", "UserId");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.travelport.schema.system_v8_0
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/system_v8_0", name = "Password")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/system_v8_0", name = "Payload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/system_v8_0", name = "SystemTime")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/system_v8_0", name = "UserId")
