...
import com.travelport.schema.hotel_v42_0.HotelRating;
import com.travelport.schema.hotel_v42_0.HotelSearchAvailabilityReq;
import com.travelport.schema.hotel_v42_0.HotelSearchLocation;
...
import com.travelport.schema.hotel_v42_0.RateInfo;
import com.travelport.schema.hotel_v42_0.TypeHotelAvailability;
import com.travelport.schema.hotel_v42_0.TypeHotelLocation;
import com.travelport.schema.hotel_v42_0.TypeHotelReferencePoint;
import com.travelport.schema.vehicle_v42_0.TypeRateAvailability;
import com.travelport.schema.vehicle_v42_0.Vehicle;
import com.travelport.schema.vehicle_v42_0.VehicleDateLocation;
import com.travelport.schema.vehicle_v42_0.VehicleModifier;
import com.travelport.schema.vehicle_v42_0.VehicleRate;
import com.travelport.schema.vehicle_v42_0.VehicleSearchAvailabilityReq;
import com.travelport.schema.vehicle_v42_0.VehicleSearchAvailabilityRsp;
...
import com.travelport.service.vehicle_v42_0.VehicleFaultMessage;
         ...
         while(hp.hasNext()){
        	 ...
        	 if(p.getHotelCode().equals(getClosestHotelCode()) || p.getHotelCode().equals(getCheapestHotelCode())){
		        ...
		        if (p.getCoordinateLocation() != null) {
		            double lat = p.getCoordinateLocation().getLatitude();
		            double lon = p.getCoordinateLocation().getLongitude();
