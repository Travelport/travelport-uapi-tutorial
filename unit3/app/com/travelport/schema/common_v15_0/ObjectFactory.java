 ...
 * generated in the com.travelport.schema.common_v15_0 package. 
...
public class ObjectFactory {
    ...
    private final static QName _SellMessage_QNAME = new QName("http://www.travelport.com/schema/common_v15_0", "SellMessage");
    private final static QName _LocationAddress_QNAME = new QName("http://www.travelport.com/schema/common_v15_0", "LocationAddress");
    private final static QName _TicketNumber_QNAME = new QName("http://www.travelport.com/schema/common_v15_0", "TicketNumber");
    private final static QName _LocatorCode_QNAME = new QName("http://www.travelport.com/schema/common_v15_0", "LocatorCode");
    private final static QName _ReferencePoint_QNAME = new QName("http://www.travelport.com/schema/common_v15_0", "ReferencePoint");
    private final static QName _GuaranteeType_QNAME = new QName("http://www.travelport.com/schema/common_v15_0", "GuaranteeType");
    private final static QName _AgencyPayment_QNAME = new QName("http://www.travelport.com/schema/common_v15_0", "AgencyPayment");
    private final static QName _ConnectionPoint_QNAME = new QName("http://www.travelport.com/schema/common_v15_0", "ConnectionPoint");
    private final static QName _SimpleName_QNAME = new QName("http://www.travelport.com/schema/common_v15_0", "SimpleName");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.travelport.schema.common_v15_0
     * 
     */
    ...
    /**
     * Create an instance of {@link BookingTravelerRef }
     * 
     */
    public BookingTravelerRef createBookingTravelerRef() {
        return new BookingTravelerRef();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/common_v15_0", name = "SellMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/common_v15_0", name = "LocationAddress")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/common_v15_0", name = "TicketNumber")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/common_v15_0", name = "LocatorCode")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/common_v15_0", name = "ReferencePoint")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/common_v15_0", name = "GuaranteeType")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/common_v15_0", name = "AgencyPayment")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/common_v15_0", name = "ConnectionPoint")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.travelport.com/schema/common_v15_0", name = "SimpleName")
