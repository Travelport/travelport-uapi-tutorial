 ...
 * 2012-05-05T13:55:28.847+02:00
 * Generated source version: 2.6.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/hotel_v17_0", name = "HotelDetailsServicePortType")
...
public interface HotelDetailsServicePortType {
    ...
    @WebResult(name = "HotelDetailsRsp", targetNamespace = "http://www.travelport.com/schema/hotel_v17_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/HotelService")
    public com.travelport.schema.hotel_v17_0.HotelDetailsRsp service(
        @WebParam(partName = "parameters", name = "HotelDetailsReq", targetNamespace = "http://www.travelport.com/schema/hotel_v17_0")
        com.travelport.schema.hotel_v17_0.HotelDetailsReq parameters
