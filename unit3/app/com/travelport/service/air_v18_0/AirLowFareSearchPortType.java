 ...
 * 2012-04-23T10:42:57.001+02:00
 * Generated source version: 2.6.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/air_v18_0", name = "AirLowFareSearchPortType")
...
public interface AirLowFareSearchPortType {
    ...
    @WebResult(name = "LowFareSearchRsp", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.air_v18_0.LowFareSearchRsp service(
        @WebParam(partName = "parameters", name = "LowFareSearchReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0")
        com.travelport.schema.air_v18_0.LowFareSearchReq parameters
