 ...
 * 2012-04-23T10:42:57.005+02:00
 * Generated source version: 2.6.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/air_v18_0", name = "FlightDetailsPortType")
...
public interface FlightDetailsPortType {
    ...
    @WebResult(name = "FlightDetailsRsp", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/FlightService")
    public com.travelport.schema.air_v18_0.FlightDetailsRsp service(
        @WebParam(partName = "parameters", name = "FlightDetailsReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0")
        com.travelport.schema.air_v18_0.FlightDetailsReq parameters
