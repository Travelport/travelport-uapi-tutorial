 ...
 * 2012-04-23T10:42:56.991+02:00
 * Generated source version: 2.6.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/air_v18_0", name = "AirPricePortType")
...
public interface AirPricePortType {
    ...
    @WebResult(name = "AirPriceRsp", targetNamespace = "http://www.travelport.com/schema/air_v18_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.air_v18_0.AirPriceRsp service(
        @WebParam(partName = "parameters", name = "AirPriceReq", targetNamespace = "http://www.travelport.com/schema/air_v18_0")
        com.travelport.schema.air_v18_0.AirPriceReq parameters
