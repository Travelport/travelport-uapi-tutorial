...
public class ServiceWrapper<S> {
    ...
    public void diagnostics(Exception e) {
        System.err.println("-------------- SERVICE WRAPPER DIAGNOSTICS----------");
        System.err.println("Caught exception type  : "+e.getClass().getName());
        System.err.println("Message                : "+e.getMessage());
        System.err.println("Service type           : "+clazzS.getName());
        System.err.println("WSDL file              : "+wsdl);
        System.err.println("WSDL expected location : "+WSDLService.getURLPrefix());
    }
