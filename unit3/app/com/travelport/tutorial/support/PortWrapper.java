...
public class PortWrapper<P,S> {
    ...
    public void diagnostics(Exception e) {
        System.err.println("-------------- PORT WRAPPER DIAGNOSTICS----------");
        System.err.println("Caught exception type: "+e.getClass().getName());
        System.err.println("Message              : "+e.getMessage());
        System.err.println("Port type            : "+port.getClass().getName());
        System.err.println("WSDL location        : "+WSDLService.getURLPrefix());
        serviceWrapper.diagnostics(e);
    }
}
